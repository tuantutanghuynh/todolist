...
export default function RegisterPage() {
  ...
  const inputClass = (field: keyof ValidationErrors) =>
    `w-full rounded-lg border px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:ring-2 ${
      errors[field]
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  autoComplete="new-password"
                  className="w-full rounded-lg border border-gray-300 px-3.5 py-2.5 pr-10 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
                />
                <button
                  type="button"
